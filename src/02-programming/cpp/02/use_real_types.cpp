...
int main()
{
  ...
  float float_variable = 3.14159265358979323846f;             // suffix f or F
  double double_variable = 3.14159265358979323846;            // no suffix
  long double long_double_variable = 3.14159265358979323846L; // suffix L or l
