...
在学习分子动力学模拟之前，需要熟悉经典力学、热力学和统计物理。本章将简要地回顾这方面的主要知识。
\end{abstract}
...
动能如何得以改变呢？让我们来看看一个力对一个粒子做的功。在一个力$\vec{F}$的作用下，如果粒子运动了一个微分位移
$$
...
\subsection{虚功原理和达朗伯 (d'Alembert) 原理}
...
\subsection{泊松 (Poisson) 括号和刘维尔算符}
